...
| `sev_snp:policy:debug`         | true: Debugging is allowed. <br/> false: Debugging is disallowed.                                                   |
| `sev_snp:policy:migrate_ma`    | true: Association with a migration agent is allowed. <br/> false: Association with a migration agent is disallowed. |
| `sev_snp:policy:smt`           | true: SMT is allowed. <br/> false: SMT is disallowed.                                                               |
